...
class PresentsWorld(hass.Hass):
	...
	def initialize(self):
		...
		self.white_list = ["light.dev12","light.dev12_2","light.dev15","light.dev54_3","light.dev54_4","light.joiner_outdoor","light.dev56","light.dev18","light.dev42","light.dev43","light.dev55"]
